...
import com.RamanoraGlobal.InDeoAppNew.AdapterClasses.BlueToothDeviceListAdapter;
...
public class DeviceListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAdapter.setListener(new BlueToothDeviceListAdapter.OnPairButtonClickListener() {
			@Override
